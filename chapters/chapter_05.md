...
<exercise id="5" title="Exercise: Data anaytics using R scripts">
...
Load both packages and use `options(scipen = 999)` to desactivate the scientific numbering.

Create a ggplot using the gapminder dataset and showing the relationship between lifeExp and gdpPercap.

Create a linear regression using the gapminder dataset with lifeExp as outcome variable and gdpPercap as perdictor variable.

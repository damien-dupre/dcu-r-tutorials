...
<opt text="Because statistics are taught by teachers who don't always know about it" correct="true">
...
Hmmm I'm not sure about that, have a look at the Occam's Razor principle

</opt>

<opt text="Because they provide fun and joy">
...
What does the slope value &beta;<sub>1</sub>?
...
It is possible to manually create the interaction variable by multiplying the values of the variables involved, try again.

</opt>

<opt text="Tests a hidden variable created by multiplying the values of the variables involved" correct="true">

...
- the slope coefficient &beta;<sub>1</sub> corresponds to how much Y increases when X increases by 1 unit. For example in our case, when  X increases from 2 to 3, that is 1 unit, Y increases from 2 to 3 as well (when X increase by 1 unit, Y increases by 1). Consequently, the slope coefficient is 1 in this example. 
